    ...
    <motion.div
      ...
      className={`p-6 sm:p-7 rounded-[28px] border-2 transition-all duration-300 relative flex flex-col justify-between ${
        !isLayerActiveInDomain
          ...
          : isLayerSelected
          ? 'bg-[#fffffb] border-[#0f172a] shadow-[8px_8px_0px_#0f172a] ring-3 ring-[#0e9384] cursor-pointer'
          : 'bg-[#fffffb] border-[#0f172a] shadow-[6px_6px_0px_#0f172a] cursor-pointer hover:border-[#0e9384]'
      }`}
    >
      <div>
          ...
          <div className="flex items-center gap-2">
            <span
              className={`px-2.5 py-1 rounded-xl text-xs font-mono font-black border ${
                isLayerActiveInDomain
                  ? 'bg-[#ffc53d] text-[#0f172a] border-[#0f172a] shadow-[2px_2px_0px_#0f172a]'
            ...
            <span
              className={`text-[11px] font-mono font-bold uppercase tracking-wider ${
                isLayerActiveInDomain ? 'text-[#0e9384]' : 'text-[#94a3b8]'
              }`}
            >
              {subtitle}
            </span>
          ...
          <div
            className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded-lg border ${
              !isLayerActiveInDomain
                ? 'bg-[#e2e8f0] text-[#94a3b8] border-[#cbd5e1]'
                : isLayerSelected
                ? 'bg-[#ffc53d] text-[#0f172a] border-[#0f172a]'
              ...
              <button
                ...
                className={`group flex items-center gap-2 px-3 py-2 rounded-xl border-2 transition-all duration-200 ${
                  !isLayerActiveInDomain || !isToolActive
                    ...
                    : isToolSelected
                    ? 'bg-[#ffc53d] border-[#0f172a] shadow-[3px_3px_0px_#0f172a] scale-105 cursor-pointer'
                    : 'bg-[#fff3df] hover:bg-[#ffc53d] border-[#0f172a] shadow-[2px_2px_0px_#0f172a] hover:scale-105 cursor-pointer'
                }`}
              >
                <div
      ...
      <div className="mt-6 pt-3 border-t border-[#0f172a]/10 flex items-center justify-between text-[11px] font-mono text-[#64748b]">
        ...
        {isLayerActiveInDomain ? (
          <button
            ...
            className="px-3 py-1 rounded-lg bg-[#fdeed3] hover:bg-[#ffc53d] text-[#0f172a] font-bold border border-[#0f172a] transition-colors cursor-pointer flex items-center gap-1"
          >
