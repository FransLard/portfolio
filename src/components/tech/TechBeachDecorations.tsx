    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden select-none z-0">
      ...
      >
        <svg width="48" height="48" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md">
          ...
          <polygon points="24,6 24,30 40,30" fill="#fffffb" stroke="#0f172a" strokeWidth="2" strokeLinejoin="round" />

          <polygon points="20,12 20,30 10,30" fill="#3ed6a4" stroke="#0f172a" strokeWidth="2" strokeLinejoin="round" />
      ...
      >
        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md">
          ...
          <path d="M6 26 C6 10 54 10 54 26 Z" fill="#ffc53d" stroke="#0f172a" strokeWidth="2" />

          <path d="M18 26 C18 13 30 10 30 10 C30 10 22 17 22 26 Z" fill="#0e9384" stroke="#0f172a" strokeWidth="1.5" />
          <path d="M42 26 C42 13 30 10 30 10 C30 10 38 17 38 26 Z" fill="#0e9384" stroke="#0f172a" strokeWidth="1.5" />

          <line x1="30" y1="10" x2="30" y2="52" stroke="#0f172a" strokeWidth="2.5" strokeLinecap="round" />

          <ellipse cx="30" cy="52" rx="14" ry="4" fill="#f7e3bd" stroke="#0f172a" strokeWidth="1.5" />
        </svg>
      </motion.div>
      ...
      <div className="absolute bottom-12 right-6 sm:right-20 opacity-85 pointer-events-none">
        <svg width="65" height="55" viewBox="0 0 70 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md">
          ...
          <ellipse cx="35" cy="52" rx="28" ry="7" fill="#f7e3bd" stroke="#0f172a" strokeWidth="1.5" />
          ...
          <path d="M12 30 Q25 24 38 22 Q52 26 58 32" stroke="#ffc53d" strokeWidth="3" strokeLinecap="round" />
