...
const inquiryTopics = [
  { id: 'web', label: 'Web App Audit', subject: 'Inquiry: Web App Security Audit' },
  { id: 'mobile', label: 'API & Auth Review', subject: 'Inquiry: API & Auth Review' },
...
export const ContactSection: React.FC = () => {
  ...
  const emailSubject = selectedTopic.subject;
  const emailBody = `Halo Frans,\n\nSaya ingin berdiskusi mengenai topik: ${selectedTopic.label}.\n\n[Tulis pesan Anda di sini]\n\nSalam,\n`;
    ...
    >
        ...
        >
          ...
          >
            <svg width="68" height="68" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-xl">
              ...
              <ellipse cx="32" cy="34" rx="24" ry="14" fill="#ffc53d" stroke="#0f172a" strokeWidth="2.5" />
              <path d="M24 20 C24 17 38 17 38 20 L38 24 L24 24 Z" fill="#facc15" stroke="#0f172a" strokeWidth="2" />
              <circle cx="24" cy="34" r="4" fill="#3ed6a4" stroke="#0f172a" strokeWidth="1.8" />
              <circle cx="34" cy="34" r="4" fill="#3ed6a4" stroke="#0f172a" strokeWidth="1.8" />
              <circle cx="44" cy="34" r="4" fill="#3ed6a4" stroke="#0f172a" strokeWidth="1.8" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-12 space-y-6 sm:space-y-8">
        <motion.div
          ...
          className="p-5 sm:p-12 rounded-[24px] sm:rounded-[36px] bg-[#fffffb] border-2 sm:border-3 border-[#0f172a] shadow-[6px_6px_0px_#0f172a] sm:shadow-[10px_10px_0px_#0f172a] space-y-5 sm:space-y-8"
        >

          <div className="space-y-3 sm:space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-2.5 sm:gap-3">
              <div className="flex items-center gap-2 px-3 sm:px-3.5 py-1 sm:py-1.5 rounded-lg sm:rounded-xl bg-[#ffc53d] text-[#0f172a] text-xs font-mono font-black border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] sm:shadow-[3px_3px_0px_#0f172a] w-fit">
            ...
            <div className="space-y-1 sm:space-y-2">
              ...
              <p className="text-xs sm:text-base text-[#475569] font-medium leading-relaxed max-w-2xl">
                Punya temuan celah, butuh audit keamanan web/API, atau sekadar diskusi santai? Hubungi saya langsung melalui email dan topik di bawah.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5 items-stretch">
            ...
            <motion.div
              ...
              className="md:col-span-7 p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#fff3df] border-2 border-[#0f172a] shadow-[3px_3px_0px_#0f172a] sm:shadow-[4px_4px_0px_#0f172a] flex flex-col justify-between space-y-4 sm:space-y-5"
            >
                    ...
                    return (
                      <button
                        ...
                        className={`px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg sm:rounded-xl text-[11px] sm:text-xs font-mono font-bold border-2 transition-all cursor-pointer ${
                          isSelected
                            ? 'bg-[#0e9384] text-white border-[#0f172a] shadow-[2px_2px_0px_#0f172a]'
                            : 'bg-[#fffffb] text-[#0f172a] border-[#0f172a] shadow-[1.5px_1.5px_0px_#0f172a] hover:bg-[#ffc53d]'
                        }`}
                      >
                        {topic.label}
                      </button>
              ...
              <div className="space-y-2 pt-2 border-t-2 border-[#0f172a]/10">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-2.5 w-full">
                  <a
                    ...
                    title="Tulis via Gmail"
                    className="inline-flex items-center justify-center gap-2 px-4 py-2.5 sm:px-5 sm:py-3 rounded-xl sm:rounded-2xl bg-[#ffc53d] hover:bg-[#facc15] text-[#0f172a] font-mono font-black text-xs sm:text-sm transition-all cursor-pointer border-2 border-[#0f172a] shadow-[2.5px_2.5px_0px_#0f172a] sm:shadow-[3px_3px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_#0f172a] w-full sm:w-auto shrink-0 whitespace-nowrap"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl sm:rounded-2xl bg-[#fffffb] hover:bg-[#ffc53d] text-[#0f172a] font-mono font-bold text-xs sm:text-sm transition-all cursor-pointer border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] w-full sm:w-auto shrink-0 whitespace-nowrap"
                    title="Salin alamat email"
                  >
                    <Mail className="w-4 h-4 text-[#0e9384] shrink-0" />
                ...
                <div className="text-[11px] font-mono text-[#64748b]">
                  <span>Tidak punya Gmail? </span>
                  <a href={mailtoLink} className="font-bold text-[#0e9384] hover:underline underline-offset-2">
                    Buka via aplikasi email
                  </a>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  className="w-full h-full p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#fff3df] border-2 border-[#0f172a] shadow-[3px_3px_0px_#0f172a] sm:shadow-[4px_4px_0px_#0f172a] flex flex-col justify-between space-y-3.5 sm:space-y-4"
                >
                  <div className="space-y-2.5 sm:space-y-3">
                    <div className="flex items-center justify-between p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-[#fffffb] border-2 border-[#0f172a]">
                      <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#475569]">
                        <Clock className="w-4 h-4 text-[#0e9384]" />
                  ...
                  <div className="space-y-2 pt-2 border-t-2 border-[#0f172a]/10">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-[10px] sm:text-[11px] font-mono font-bold text-[#0e9384] hover:text-[#0f172a] cursor-pointer"
                      >
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-2.5">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2 sm:p-2.5 rounded-xl sm:rounded-2xl bg-[#fffffb] hover:bg-[#ffc53d] text-[#0f172a] font-mono font-bold text-[11px] sm:text-xs transition-all border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_#0f172a] flex items-center justify-between group"
                      >
                      ...
                      >
                        <div className="flex items-center gap-1.5">
                          <svg className="w-3.5 h-3.5 text-[#0e9384]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div
                  ...
                  className="absolute inset-0 p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#ffc53d] border-2 border-[#0f172a] shadow-[3px_3px_0px_#0f172a] sm:shadow-[4px_4px_0px_#0f172a] flex flex-col justify-between space-y-3"
                >
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-medium text-[#1e293b] leading-relaxed">
                      Terima kasih sudah menjelajahi portofolio ini sampai tuntas! Selalu terbuka untuk ngobrol santai seputar AppSec, OWASP, Burp/ZAP, atau kolaborasi audit yang seru.
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-2 px-3 rounded-xl bg-[#fffffb] hover:bg-[#fff3df] text-[#0f172a] text-xs font-mono font-black border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] transition-all cursor-pointer flex items-center justify-center gap-1.5"
                  >
                    <RotateCw className="w-3 h-3" />
        ...
        <motion.div
          ...
          className="p-4 sm:p-6 rounded-2xl sm:rounded-[28px] bg-[#fffffb] border-2 sm:border-3 border-[#0f172a] shadow-[4px_4px_0px_#0f172a] sm:shadow-[6px_6px_0px_#0f172a] flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-[11px] sm:text-xs font-mono font-bold text-[#475569]"
        >
          <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 text-[#0f172a] text-center sm:text-left">
            ...
            <span className="text-[10px] sm:text-xs text-[#64748b] sm:text-[#0f172a] font-normal sm:font-bold">
              Aspiring AppSec Engineer • Open for Internship
            </span>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto">
            ...
            <button
              type="button"
              onClick={scrollToTop}
              className="px-4 py-1.5 sm:px-3.5 sm:py-1.5 rounded-xl bg-[#fff3df] hover:bg-[#ffc53d] text-[#0f172a] border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] transition-all cursor-pointer flex items-center justify-center gap-1.5 font-mono font-bold text-xs"
            >
              <span>Ke Atas</span>
