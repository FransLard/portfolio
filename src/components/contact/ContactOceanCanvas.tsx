...
export const ContactOceanCanvas: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      drawWaveCrest(height * 0.20, 0.005, 8, 1.0, 0.35, '#3ed6a4');
      drawWaveCrest(height * 0.50, 0.004, 10, 0.8, 0.30, '#1abf9c');
      ...
      seabedGrad.addColorStop(0, '#f5d9a8');
      seabedGrad.addColorStop(0.5, '#f7e3bd');
      seabedGrad.addColorStop(1.0, '#f3d9ae');
