    ...
    <section id="journey" ref={containerRef} className="relative z-20 -mt-1 w-full select-none py-28 overflow-hidden text-[#0f172a]">
      ...
      >
        <svg width="56" height="56" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-xl">
          ...
          <circle cx="27" cy="27" r="11" fill="#0e9384" stroke="#0f172a" strokeWidth="2.5" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-12 space-y-8 sm:space-y-12">
        ...
        <motion.div
          ...
          className="p-4 sm:p-8 rounded-2xl sm:rounded-[32px] bg-[#fffffb] border-2 sm:border-3 border-[#0f172a] shadow-[4px_4px_0px_#0f172a] sm:shadow-[6px_6px_0px_#0f172a] space-y-2.5 sm:space-y-3"
        >
          <div className="flex items-center gap-2 px-3 sm:px-3.5 py-1 sm:py-1.5 rounded-xl bg-[#ffc53d] text-[#0f172a] text-xs font-mono font-black border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] sm:shadow-[3px_3px_0px_#0f172a] w-fit">
        ...
        <div className="relative pl-11 sm:pl-20 space-y-7 sm:space-y-12">
          ...
          <div className="absolute top-5 sm:top-6 bottom-5 sm:bottom-6 left-4 sm:left-7 -translate-x-1/2 w-2.5 sm:w-3.5 bg-black/30 rounded-full overflow-hidden border-2 border-white/50 shadow-inner z-0">
            ...
            <motion.div
              ...
              className="w-full h-full bg-gradient-to-b from-[#ffc53d] via-[#3ed6a4] via-[#4ade80] to-[#fb7185] rounded-full shadow-[0_0_16px_rgba(56,189,248,0.9)]"
            />
          </div>
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="p-4 sm:p-8 rounded-2xl sm:rounded-[32px] bg-[#fffffb] border-2 sm:border-3 border-[#0f172a] shadow-[4px_4px_0px_#0f172a] sm:shadow-[6px_6px_0px_#0f172a] hover:shadow-[3px_3px_0px_#0f172a] hover:translate-x-1 hover:translate-y-1 transition-all duration-300 space-y-3 sm:space-y-4 cursor-default"
                >
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3 pb-3 sm:pb-4 border-b-2 border-[#0f172a]/10">
                    ...
                    <div className="flex items-center gap-1.5 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-lg sm:rounded-xl bg-[#fff3df] border-2 border-[#0f172a] text-[10px] sm:text-xs font-mono font-black text-[#0f172a] shadow-[1.5px_1.5px_0px_#0f172a] sm:shadow-[2px_2px_0px_#0f172a]">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-2xl font-black text-[#0f172a] tracking-tight group-hover:text-[#0e9384] transition-colors">
                      {item.role}
                    </h3>
                    <div className="text-xs sm:text-sm font-mono font-bold text-[#0e9384] mt-0.5 sm:mt-1">
                      {item.organization}
                    </div>
                  </div>
                  ...
                  {item.highlights && item.highlights.length > 0 && (
                    <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-[#fff3df]/80 border border-[#0f172a]/20 sm:border-2 sm:border-[#0f172a]/15 space-y-1.5 sm:space-y-2">
                  ...
                  <div className="pt-1 sm:pt-2 flex flex-wrap gap-1.5 sm:gap-2">
                    {item.tech.map((t) => (
                      <span
                        key={t}
                        className="text-[10px] sm:text-xs font-mono font-bold px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg sm:rounded-xl bg-[#fff3df] hover:bg-[#ffc53d] text-[#0f172a] border border-[#0f172a] transition-colors"
                      >
                        {t}
                      </span>
                    ))}
