...
interface FlagshipSlideCardProps {
  ...
  index: number;
  total?: number;
  yMotion?: MotionValue<string> | string;
  opacityMotion?: MotionValue<number> | number;
  depthLevel?: 1 | 2 | 3 | 4;
...
export const FlagshipSlideCard: React.FC<FlagshipSlideCardProps> = ({
  ...
  const depth = depthLevel ?? ((index % 3) + 1) as 1 | 2 | 3 | 4;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full pt-20 sm:pt-24 px-6 sm:px-12 flex items-center justify-between">
        ...
        <div className="hidden sm:block text-xs font-mono font-black text-[#0f172a] px-3.5 py-1.5 rounded-xl bg-[#fffffb] border-2 border-[#0f172a] shadow-[3px_3px_0px_#0f172a]">
          FLAGSHIP {index + 1} / {total ?? 3}
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-12 my-auto py-2 sm:py-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 p-4 sm:p-7 sm:p-9 rounded-2xl sm:rounded-[32px] bg-[#fffffb] border-2 border-[#0f172a] shadow-[5px_5px_0px_#0f172a] sm:shadow-[8px_8px_0px_#0f172a] space-y-3 sm:space-y-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] sm:text-sm font-mono font-bold text-[#0e9384] leading-relaxed">
                {project.subtitle}
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-1 sm:gap-1.5 pt-0.5 sm:pt-1">
              {project.stack.slice(0, 6).map((tech) => (
                <span
                  key={tech}
                  className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg sm:rounded-xl bg-[#fff3df] text-[10px] sm:text-[11px] font-mono font-bold text-[#0f172a] border border-[#0f172a]/50"
                >
                  {tech}
                </span>
              ))}
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2 sm:gap-3 border-t border-[#ecd0a0]">

              <button
                type="button"
                onClick={() => onSelectProject(project)}
                className="flex items-center gap-1.5 sm:gap-2 px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-xl bg-[#0e9384] hover:bg-[#0b6e63] text-white text-[11px] sm:text-xs font-mono font-black border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] sm:shadow-[3px_3px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none transition-all cursor-pointer"
              >
              ...
              {project.isMobileApp ? (
                <div
                  className="flex items-center gap-1.5 sm:gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-[#e0f2fe] text-[#0b6e63] text-[11px] sm:text-xs font-mono font-bold border-2 border-[#0e9384]/50 cursor-not-allowed opacity-90"
                  title={project.demoStatusLabel || 'Aplikasi Mobile Native'}
                >
                  <Smartphone className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#0e9384]" />
                ...
                <a
                  ...
                  className="flex items-center gap-1.5 sm:gap-2 px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-xl bg-[#ffc53d] hover:bg-[#facc15] text-[#0f172a] text-[11px] sm:text-xs font-mono font-black border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] sm:shadow-[3px_3px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none transition-all"
                >
              ...
              {project.isPrivateRepo ? (
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 sm:gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-[#fff3df] hover:bg-[#fdeed3] text-[#0f172a] text-[11px] sm:text-xs font-mono font-bold border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] sm:shadow-[3px_3px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none transition-all sm:ml-auto"
                >
