    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl bg-[#fffffb] rounded-2xl sm:rounded-[32px] border-2 sm:border-4 border-[#0f172a] shadow-[6px_6px_0px_#0f172a] sm:shadow-[12px_12px_0px_#0f172a] p-4 sm:p-8 space-y-4 sm:space-y-6 z-10 my-4 sm:my-8 max-h-[92vh] overflow-y-auto"
        >

          <div className="flex items-start justify-between gap-3 sm:gap-4 border-b-2 border-[#0f172a]/20 pb-3 sm:pb-4">
            <div>
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                <span className="text-[10px] sm:text-xs font-mono font-black uppercase tracking-wider text-[#0f172a] bg-[#ffc53d] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md sm:rounded-lg border-2 border-[#0f172a]">
              ...
              <p className="text-xs sm:text-sm font-mono font-bold text-[#0e9384] mt-0.5">
                {project.subtitle}
              </p>
            </div>
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-2 sm:p-2.5 rounded-xl sm:rounded-2xl bg-[#fff3df] hover:bg-[#fee2e2] border-2 border-[#0f172a] text-[#0f172a] hover:text-[#dc2626] shadow-[2px_2px_0px_#0f172a] sm:shadow-[3px_3px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none transition-all cursor-pointer shrink-0"
          ...
          <div className="grid grid-cols-3 gap-1.5 sm:gap-3">
            {project.metrics.map((m, idx) => {
              ...
              const labelColor = idx === 0 ? 'text-[#0b6e63]' : idx === 1 ? 'text-[#854d0e]' : 'text-[#15803d]';
          ...
          <div className="space-y-2">
            <h4 className="text-[11px] sm:text-xs font-mono uppercase font-black text-[#0f172a] flex items-center gap-2">
              <Layers className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0e9384]" />
              <span>Latar Belakang &amp; Mandat Proyek</span>
            </h4>
            <p className="text-xs sm:text-base text-[#334155] leading-relaxed bg-[#fff3df] p-3.5 sm:p-5 rounded-xl sm:rounded-2xl border-2 border-[#0f172a]/30 font-medium">
              {project.description}
            </p>
          </div>
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-mono uppercase font-black text-[#0f172a] flex items-center gap-2">
              <Code2 className="w-4 h-4 text-[#0e9384]" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {project.architecture.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-3 p-3.5 rounded-xl bg-[#fff3df] border border-[#0f172a]/30 text-xs sm:text-sm text-[#0f172a] font-medium"
                >
          ...
          <div className="space-y-2.5">
            ...
            <div className="flex flex-wrap gap-2">
              {project.stack.map((tech) => (
                <span
                  key={tech}
                  className="text-xs font-mono font-bold px-3 py-1.5 rounded-xl bg-[#fff3df] text-[#0f172a] border border-[#0f172a]/50"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="pt-6 border-t-2 border-[#0f172a]/20 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {project.isMobileApp ? (
                <div
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#e0f2fe] text-[#0b6e63] text-xs font-mono font-bold border-2 border-[#0e9384]/50 opacity-90 cursor-not-allowed"
                  title={project.demoStatusLabel || 'Aplikasi Mobile Native'}
                >
                  <Smartphone className="w-4 h-4 text-[#0e9384]" />
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0e9384] hover:bg-[#0b6e63] text-white text-xs font-mono font-black border-2 border-[#0f172a] shadow-[3px_3px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none transition-all"
                >
              ...
              {project.isPrivateRepo ? (
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#fff3df] hover:bg-[#fdeed3] text-[#0f172a] text-xs font-mono font-black border-2 border-[#0f172a] shadow-[3px_3px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none transition-all"
                >
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2.5 rounded-xl bg-[#fffffb] hover:bg-[#fff3df] text-[#0f172a] text-xs font-mono font-black border-2 border-[#0f172a] shadow-[3px_3px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none transition-all cursor-pointer text-center"
            >
              Tutup Dialog
            </button>
          </div>
