...
export const GithubActivitySection: React.FC = () => {
  ...
  const githubUrl = profileData.contact.github || 'https://github.com/franslampard';
  const username = githubUrl.split('/').filter(Boolean).pop() || 'franslampard';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8">
        ...
        >
          <div className="max-w-2xl">
            <span className="text-xs font-mono font-bold uppercase tracking-[0.25em] text-[#8a5a24] block mb-2">
              AKTIVITAS GITHUB
            </span>
        ...
        <motion.div
          ...
          className="mt-8 sm:mt-12 rounded-[24px] sm:rounded-[32px] p-4 sm:p-9 bg-[#fffffb] border-2 border-[#0f172a] shadow-[4px_4px_0px_#0f172a] sm:shadow-[6px_6px_0px_#0f172a]"
        >

          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-[#ecd7b0]">
            <div className="flex items-center justify-between sm:justify-start gap-2 sm:gap-2.5 w-full sm:w-auto">
              <a
                href={githubUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-3.5 sm:py-1.5 rounded-xl bg-[#fff3df] hover:bg-[#fff0b3] border-2 border-[#0f172a] text-[#0f172a] text-xs font-mono font-bold shadow-[2px_2px_0px_#0f172a] transition-all hover:-translate-y-0.5"
              >
                <SiGithub className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0f172a]" />
                <span>@{username}</span>
              </a>

              <span className="px-2.5 py-1.5 sm:px-3 sm:py-1.5 rounded-xl bg-[#fffffb] border-2 border-[#0f172a] text-[11px] sm:text-xs font-mono font-bold text-[#8a5a24] shadow-[2px_2px_0px_#0f172a]">
                ...
                return (
                  <button
                    ...
                    className={`px-3 py-1.5 sm:px-3.5 sm:py-1.5 rounded-xl text-[11px] sm:text-xs font-mono font-bold transition-all cursor-pointer shrink-0 whitespace-nowrap ${
                      isActive
                        ? 'bg-[#0e9384] text-white shadow-[2px_2px_0px_#0f172a] border-2 border-[#0f172a] -translate-y-0.5'
                        : 'bg-[#fff3df] text-[#475569] hover:bg-[#fdeed3] hover:text-[#0f172a] border-2 border-[#0f172a] hover:-translate-y-0.5 shadow-[2px_2px_0px_#0f172a]'
                    }`}
                  >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3.5 pt-4 sm:pt-6 border-t border-[#ecd7b0]">
            <div className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-[#fff3df] border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a]">
              <div className="flex items-center gap-1.5 sm:gap-2 text-[#8a5a24] text-[10px] sm:text-xs font-mono font-bold">
                <GitCommit className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0e9384]" />
            ...
            >
              <div className="flex items-center justify-between text-[10px] sm:text-xs font-mono font-bold text-[#3ed6a4]">
