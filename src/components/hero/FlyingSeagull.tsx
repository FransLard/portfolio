        ...
        >
          ...
          {currentQuip && (
            <motion.div
              ...
              className={`absolute -top-9 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-white text-[#0e9384] text-[11px] font-bold border border-[#3ed6a4] whitespace-nowrap flex items-center gap-1 ${
