...
const DUCK_DIALOGUES = [
  ...
  'Berenang santai sambil nemenin kamu lihat portofolio Frans Lampard ~',
    ...
    >
      ...
      >
        ...
        {isWaddling && currentExpression !== 'impact' && (
          <motion.div className="absolute -top-7 left-1/2 -translate-x-1/2 px-2.5 py-0.5 rounded-full bg-[#3ed6a4] text-white text-[10px] font-extrabold shadow-lg border border-[#0e9384] whitespace-nowrap">
            BACK TO WATER!
          </motion.div>
        )}
