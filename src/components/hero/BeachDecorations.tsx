    ...
    <div className="absolute inset-x-0 bottom-0 h-64 z-20 pointer-events-none overflow-hidden select-none">
      ...
      >
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute bottom-2 left-6 w-28 h-10 bg-[#f7e3bd]/80 rounded-full blur-[3px] -rotate-6" />
      ...
      >
        <div className="relative">
          <div className="absolute bottom-2 left-6 w-96 h-14 bg-[#f7e3bd]/75 rounded-full blur-[3px]" />
          ...
          <svg width="380" height="125" viewBox="0 0 380 125" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-sm">
            ...
            <line x1="190" y1="12" x2="190" y2="60" stroke="#8a5a24" strokeWidth="5" strokeLinecap="round" />
            <line x1="190" y1="68" x2="190" y2="120" stroke="#8a5a24" strokeWidth="5" strokeLinecap="round" />
            ...
            <g transform="translate(255, 78)">
              <ellipse cx="11" cy="20" rx="10" ry="3.5" fill="#f7e3bd" />
              <circle cx="11" cy="11" r="10.5" fill="#FFFFFF" stroke="#0e9384" strokeWidth="1.2" />
              <path d="M6 3 C8 7, 11 15, 6 20" stroke="#0e9384" strokeWidth="3" />
      ...
      >
        ...
        >
          <div className="w-6 h-2 bg-[#f7e3bd]/80 rounded-full blur-[1px] translate-y-1" />
        ...
        >
          <div className="absolute -bottom-1 left-2 w-24 h-4 bg-[#f7e3bd]/80 rounded-full blur-[2px]" />
          <svg width="95" height="42" viewBox="0 0 95 42" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-md">
            <line x1="12" y1="28" x2="8" y2="40" stroke="#8a5a24" strokeWidth="3" strokeLinecap="round" />
            <line x1="50" y1="28" x2="48" y2="40" stroke="#8a5a24" strokeWidth="3" strokeLinecap="round" />
            <line x1="82" y1="18" x2="86" y2="40" stroke="#8a5a24" strokeWidth="3" strokeLinecap="round" />
            <path
        ...
        >
          <div className="absolute -bottom-1 left-4 w-28 h-8 bg-[#f7e3bd]/80 rounded-full blur-[3px]" />
