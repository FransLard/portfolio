              ...
              >
                <defs>
                  <linearGradient id="deepWaveGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <stop offset="60%" stopColor="#0a3f38" stopOpacity="0.85" />
                    <stop offset="85%" stopColor="#0e9384" stopOpacity="0.88" />
                    <stop offset="100%" stopColor="#1abf9c" stopOpacity="0.92" />
                  </linearGradient>

                  <linearGradient id="crestCyanGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#0e9384" stopOpacity="0.9" />
                    <stop offset="70%" stopColor="#3ed6a4" stopOpacity="0.95" />
