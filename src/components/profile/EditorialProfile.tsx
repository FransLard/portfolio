...
export const EditorialProfile: React.FC = () => {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="relative pt-24 pb-32 sm:pt-28 sm:pb-44 bg-[#fff3df] overflow-hidden select-none"
    >
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-10 sm:pb-14 border-b border-[#ecd0a0]"
        >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <p className="max-w-xs text-xs text-[#475569] leading-relaxed">
              Fokus audit keamanan aplikasi web & API: review source code, uji OWASP Top 10 pakai Burp/ZAP, dan hardening deploy Linux sebelum rilis.
            </p>
          </div>
        </motion.div>
      ...
      <div className="absolute bottom-0 inset-x-0 h-24 sm:h-32 pointer-events-none z-20 overflow-hidden">
        ...
        >
          <path
            ...
            fill={isFlooded ? '#f3d9ae' : '#f7e3bd'}
            opacity="0.95"
          />
          <path
            d="M0,105 Q420,60 820,100 T1440,85 L1440,180 L0,180 Z"
            fill={isFlooded ? '#d9b382' : '#f3d9ae'}
          />
        </svg>
      </div>
    </section>
