...
export const RebuildConstructionOverlay: React.FC<RebuildConstructionOverlayProps> = ({
  ...
  const comicSounds = [
    ...
    { icon: <Wrench className="w-5 h-5 text-[#0e9384]" />, label: 'FIXING!' },
    { icon: <Cpu className="w-5 h-5 text-[#059669]" />, label: 'STRUCTURING!' },
    { icon: <Terminal className="w-5 h-5 text-[#8a5a24]" />, label: 'RESTORE!' },
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden flex items-center justify-center">
            ...
            >
              <svg viewBox="0 0 600 450" fill="none" className="w-full h-full drop-shadow-2xl">
                ...
                <circle cx="470" cy="240" r="90" fill="#fffffb" />
              </svg>
            </motion.div>
          ...
          <div className="relative z-20 flex flex-col items-center justify-center text-center space-y-3 sm:space-y-6 max-w-lg mx-4 sm:mx-6 scale-90 sm:scale-100">
            ...
            <div className="w-full max-w-xs sm:max-w-sm space-y-1.5 sm:space-y-2 pt-1 sm:pt-2">
              <div className="w-full h-3.5 sm:h-4 rounded-full bg-white/90 border-2 border-[#f3d9ae] p-0.5 overflow-hidden shadow-xl">
                <motion.div
                  className="h-full rounded-full bg-gradient-to-r from-[#f59e0b] via-[#0e9384] to-[#3ed6a4] shadow-md"
                  style={{ width: `${progress}%` }}
                  transition={{ ease: 'easeOut' }}
                />
              </div>

              <div className="flex items-center justify-between text-xs font-mono font-bold text-[#8a5a24] px-1">
